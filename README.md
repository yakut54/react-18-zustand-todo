...
- Undo удаления — toast с обратным отсчётом 5 сек, отмена без лишних кликов
- Защита от дубликатов — проверка на фронте через getState + UNIQUE constraint в БД
- Drag-to-scroll — зажать ЛКМ и тянуть список мышью (useDragScroll хук)
